...
public:
	Person(const string& name, const string& surname, const int& age) {
		...
		birth_date = age;
		year_to_first_name[birth_date] = birth_name;
		year_to_last_name[birth_date] = birth_surname;
	}
	...
	string GetFullNameWithHistory(int year) const {
		...
		// ïîëó÷èòü âñå èìåíà è ôàìèëèè ïî ñîñòîÿíèþ íà êîíåö ãîäà year
	}
private:
	string birth_name, birth_surname;
	int birth_date;
